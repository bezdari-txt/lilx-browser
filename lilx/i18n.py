...
_RU: dict[str, str] = {
    ...
    "Private": "Приватное",
    "Private window: history, cookies and site data are not saved": "Приватное окно: история, cookies и данные сайтов не сохраняются",
    "Extensions are off in private windows": "В приватных окнах расширения отключены",
    "Allow": "Разрешить",
    "Block": "Запретить",
    "Remember for this site": "Запомнить для этого сайта",
    "Remember until private windows close": "Запомнить до закрытия приватных окон",
    "{origin} wants to use your camera": "{origin} запрашивает доступ к камере",
    "{origin} wants to use your microphone": "{origin} запрашивает доступ к микрофону",
    "{origin} wants to use your camera and microphone": "{origin} запрашивает доступ к камере и микрофону",
    "{origin} wants to know your location": "{origin} запрашивает ваше местоположение",
    "{origin} wants to show notifications": "{origin} хочет показывать уведомления",
    "{origin} wants to read and change your clipboard": "{origin} запрашивает доступ к буферу обмена",
    "{origin} wants a permission": "{origin} запрашивает разрешение",
