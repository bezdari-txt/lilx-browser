...
_PATHS: dict[str, str] = {
    ...
    "private": '<path d="M4 11h16"/><path d="M7 11l1.6-5.2a1 1 0 0 1 1.2-.7L12 5.7l2.2-.6a1 1 0 0 1 1.2.7L17 11"/><circle cx="8" cy="16" r="2.6"/><circle cx="16" cy="16" r="2.6"/><path d="M10.6 16h2.8"/>',
